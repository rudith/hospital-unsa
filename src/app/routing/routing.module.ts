...
const VERTICAL_ROUTES: Routes = [
  ...
  {
    path: "search-pagination-table",
    component: PageSearchPaginationTableComponent
  },
  ...
  { path: "citas",canActivate:[LoginGuard], component: CitasComponent },
  { path: "historial",canActivate:[LoginGuard], component: HistorialComponent },
  { path: "adminUser",canActivate:[LoginGuard], component: EditarComponent },
  { path: "typeUser",canActivate:[LoginGuard], component: TipoPersonalComponent },
  { path: "especialidad",canActivate:[LoginGuard], component: EspecialidadComponent },
  { path: "area",canActivate:[LoginGuard], component: AreaComponent },
